...
const LevelTwoOutput = () => {
    ...
    const handleClickRestart = async () => {
        ...
        await updatePlayerData(user.uid, {
            ...
            level: 0,
            goal: '',
            result: {econompattern: 0, impulsivepattern: 0, strategicalpattern: 0, mixedpattern: 0}
        });
    ...
    return (
        <div className="game-page">
            <div className="game-card" style={{maxWidth: '600px'}}>
                <h1 className="game-title">✅ Niveau 2 terminé!</h1>
                
                <div className="game-message-success" style={{marginBottom: '2rem'}}>
                    <p style={{fontSize: '1.125rem', marginBottom: '1rem'}}>Félicitations! Tu as appris à comparer les prix et à chercher les bonnes affaires!</p>
                </div>
                ...
                <div className="game-choices">
                    <Button onClick={handleClickRestart} text="🔄 Recommencer" secondary />
                    <NavLink to="/level-three" className="game-link">
                        ▶️ Niveau suivant
                    </NavLink>
                </div>
            </div>
