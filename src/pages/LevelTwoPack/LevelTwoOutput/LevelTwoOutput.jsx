    ...
    return (
        <div className="game-page">
            <div className="game-card" style={{maxWidth: '600px'}}>
                <h1 className="game-title">✅ Рівень 2 завершено!</h1>
                
                <div className="game-message-success" style={{marginBottom: '2rem'}}>
                    <p style={{fontSize: '1.125rem', marginBottom: '1rem'}}>Вітаємо! Ти навчився порівнювати ціни та шукати вигідні пропозиції!</p>
                </div>
